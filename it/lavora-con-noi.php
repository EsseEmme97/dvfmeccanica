...
// $database = new DB();
$titleseo = "Lavora con Noi in DVF Meccanica";
$descriptionseo = "Siamo alla ricerca di talenti! Scopri le posizioni aperte e le opportunità di carriera in DVF Meccanica. Invia ora il tuo CV e unisciti al nostro team.
";
$image = "assets/images/global/favicon/DVF-favicon.ico";
$widthseo = "400";
$heightseo = "115";

/* rimuovere in produzione, dati presi dal database */
$jobOffers = ["Impiegato amministrativo", "addetto alla produzione specializzato", "addetto al controllo qualità", "impiegato/a backoffice commerciale"]
?>
<!DOCTYPE html>
<html lang="it">
			...
			<div class="row section-row align-items-center">
				<div class="col-lg-6">
					...
					<div class="section-title">
						<span class="wow fadeInUp label text-black">LAVORA CON NOI</span>
						<h2 class="text-anime-style-2" data-cursor="-opaque">Entra a far parte del team <span> DVF Meccanica</span></h2>
					</div>
					<!-- Section Title End -->
				</div>
				<div class="col-lg-6">
					...
					<div class="section-title-content wow fadeInUp" data-wow-delay="0.25s">
						<p>In DVF Meccanica siamo sempre alla ricerca di talenti appassionati e motivati che possano entrare a far parte del nostro team.
							Se siete interessati/e a una delle nostre posizioni aperte, vi invitiamo a inviare il vostro CV per essere considerati/e nei nostri processi di selezione.
							In alternativa, potrete sempre inviare una candidatura spontanea per farci conoscere il vostro profilo professionale.</p>
					</div>
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="service-item">
							...
							<div class="service-body text-center">
								<span class="h3"><?= $jobOffer ?></span>
							</div>

							<div class="text-center mt-5">
								<div class="hero-btn wow fadeInUp" data-wow-delay="0.4s">
									<a href="<?= $pathindex . "lavora-con-noi/" . str_replace(" ", "-", strtolower($jobOffer)) ?>" class="btn-default"><span>Scopri di più</span></a>
								</div>
							</div>
						</div>
						<!-- Service Item End -->
						...
						<div class="contact-form">
							...
							<form id="contactForm" action="#" method="POST" data-toggle="validator" class="wow fadeInUp" data-wow-delay="0.5s">
								<div class="row">
									...
									<div class="form-group col-md-12 mb-4">
										<select name="candidatura" id="candidatura" class="form-control" required>
									...
									<div class="form-group col-md-12 mb-5">
										<input type="checkbox" name="consenso" id="consenso" required> Acconsento al trattamento dei dati personali ai sensi del Regolamento (UE) 2016/679 (GDPR).
										<div class="help-block with-errors"></div>
									</div>
